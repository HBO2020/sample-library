...
class ImageResourceIT {
    ...
    private static final byte[] DEFAULT_IMAGE_BOOK = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_IMAGE_BOOK = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_IMAGE_BOOK_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_IMAGE_BOOK_CONTENT_TYPE = "image/png";

    private static final String DEFAULT_IMAGE_LIBELLE = "AAAAAAAAAA";
    private static final String UPDATED_IMAGE_LIBELLE = "BBBBBBBBBB";

    private static final Integer DEFAULT_IMAGE_CODE = 1;
    private static final Integer UPDATED_IMAGE_CODE = 2;
    ...
    public static Image createEntity(EntityManager em) {
        Image image = new Image()
            .imageBook(DEFAULT_IMAGE_BOOK)
            .imageBookContentType(DEFAULT_IMAGE_BOOK_CONTENT_TYPE)
            .imageLibelle(DEFAULT_IMAGE_LIBELLE)
    ...
    public static Image createUpdatedEntity(EntityManager em) {
        Image image = new Image()
            .imageBook(UPDATED_IMAGE_BOOK)
            .imageBookContentType(UPDATED_IMAGE_BOOK_CONTENT_TYPE)
            .imageLibelle(UPDATED_IMAGE_LIBELLE)
    ...
    void createImage() throws Exception {
        ...
        assertThat(testImage.getImageBook()).isEqualTo(DEFAULT_IMAGE_BOOK);
        assertThat(testImage.getImageBookContentType()).isEqualTo(DEFAULT_IMAGE_BOOK_CONTENT_TYPE);
        assertThat(testImage.getImageLibelle()).isEqualTo(DEFAULT_IMAGE_LIBELLE);
        assertThat(testImage.getImageCode()).isEqualTo(DEFAULT_IMAGE_CODE);
    }
    ...
    void getAllImages() throws Exception {
        ...
        restImageMockMvc
            ...
            .andExpect(jsonPath("$.[*].imageBookContentType").value(hasItem(DEFAULT_IMAGE_BOOK_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].imageBook").value(hasItem(Base64Utils.encodeToString(DEFAULT_IMAGE_BOOK))))
            .andExpect(jsonPath("$.[*].imageLibelle").value(hasItem(DEFAULT_IMAGE_LIBELLE)))
    ...
    void getImage() throws Exception {
        ...
        restImageMockMvc
            ...
            .andExpect(jsonPath("$.imageBookContentType").value(DEFAULT_IMAGE_BOOK_CONTENT_TYPE))
            .andExpect(jsonPath("$.imageBook").value(Base64Utils.encodeToString(DEFAULT_IMAGE_BOOK)))
            .andExpect(jsonPath("$.imageLibelle").value(DEFAULT_IMAGE_LIBELLE))
    ...
    void putNewImage() throws Exception {
        ...
        Image testImage = imageList.get(imageList.size() - 1);
        assertThat(testImage.getImageBook()).isEqualTo(UPDATED_IMAGE_BOOK);
        assertThat(testImage.getImageBookContentType()).isEqualTo(UPDATED_IMAGE_BOOK_CONTENT_TYPE);
        assertThat(testImage.getImageLibelle()).isEqualTo(UPDATED_IMAGE_LIBELLE);
        assertThat(testImage.getImageCode()).isEqualTo(UPDATED_IMAGE_CODE);
    }
    ...
    void partialUpdateImageWithPatch() throws Exception {
        ...
        partialUpdatedImage.imageLibelle(UPDATED_IMAGE_LIBELLE).imageCode(UPDATED_IMAGE_CODE);
